...
5. Set environment variable:
   ...
   - Google Workspace is the fixed organization provider. No provider secret or organization identity belongs in frontend environment variables.
...
- Rollback is backend environment-selected only. The normal frontend contains no credential input or shared-secret compatibility path.
